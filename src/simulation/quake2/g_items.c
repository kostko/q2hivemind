...
//			agent_entityappear( g_edicts[i].client->botinfo.agent, ent - g_edicts );
//	}
	// -- Fear End --
...
//	int i;
 ...
 // -- FEAR Begin --
/*	if (taken)
		bot_personal_event(other->client->botinfo.body, event_message("SelfPickup"));*/
 // -- FEAR End --
...
void SetItemNames (void)
{
	...
	for (i=0 ; i<game.num_items ; i++)
	{
	 ...
	 /*
		if (it->classname)
			itemptr[i] = entity_allocate((entity_t)i,it->classname);
		else
			itemptr[i] = NULL;				*/
	 // -- FEAR End --
	}
